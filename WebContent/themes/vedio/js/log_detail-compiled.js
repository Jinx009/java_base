...
function _draw(_list, num, task, area) {
  ...
  var pathStr = 'M ' + c_1.attr('cx') + ' ' + c_1.attr('cy') + ' L ' + c_2.attr('cx') + ' ' + c_2.attr('cy') + ' L ' + c_3.attr('cx') + ' ' + c_3.attr('cy') + ' L ' + c_4.attr('cx') + ' ' + c_4.attr('cy') + ' L ' + c_1.attr('cx') + ' ' + c_1.attr('cy');
  ...
  for (var i in _list) {
    ...
    var pathStr = 'M ' + car1.attr('cx') + ' ' + car1.attr('cy') + ' L ' + car2.attr('cx') + ' ' + car2.attr('cy') + ' L ' + car3.attr('cx') + ' ' + car3.attr('cy') + ' L ' + car4.attr('cx') + ' ' + car4.attr('cy') + ' L ' + car1.attr('cx') + ' ' + car1.attr('cy');
    ...
    if (obj.cpX != '') {
      ...
      var pathStr = 'M ' + cp1.attr('cx') + ' ' + cp1.attr('cy') + ' L ' + cp2.attr('cx') + ' ' + cp2.attr('cy') + ' L ' + cp3.attr('cx') + ' ' + cp3.attr('cy') + ' L ' + cp4.attr('cx') + ' ' + cp4.attr('cy') + ' L ' + cp1.attr('cx') + ' ' + cp1.attr('cy');
...
//# sourceMappingURL=log_detail-compiled.js.map