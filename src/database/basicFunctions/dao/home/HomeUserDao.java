...
public class HomeUserDao extends BaseDao<HomeUser>{
	...
	public List<HomeUserVo> getHomeUser() throws ParseException {
		String sql = "SELECT a.USER_NAME,a.ID,b.NAME,a.CREATE_TIME,b.LEVEL,a.STATUS,a.REAL_NAME FROM HOME_USER a,HOME_ROLE b,HOME_USER_ROLE c WHERE a.ID!=1 AND a.ID = c.USER_ID AND c.ROLE_ID = b.ID";
