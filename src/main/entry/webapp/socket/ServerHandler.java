...
public class ServerHandler extends ChannelInboundHandlerAdapter {
	...
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		...
		HttpUtils.get("http://127.0.0.1:8080/d/socketSave?status=conn&ip="+ctx.channel().remoteAddress().toString().split(":")[0]+"_9999");
	...
	public void channelReadComplete(ChannelHandlerContext ctx) throws Exception {
		HttpUtils.get("http://127.0.0.1:8080/d/socketSave?status=close&ip="+ctx.channel().remoteAddress().toString().split(":")[0]+"_9999");
		ctx.flush();
	}
