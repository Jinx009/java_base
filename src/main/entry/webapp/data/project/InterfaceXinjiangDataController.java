...
@Controller
@RequestMapping(value = "/interface/xj")
public class InterfaceXinjiangDataController extends BaseController{

	private static final Logger log = LoggerFactory.getLogger(InterfaceXinjiangDataController.class); 
