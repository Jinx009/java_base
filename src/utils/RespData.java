...
public class RespData {
	...
	public static final String OK_MSG = "访问成功";
	public static final String NOT_FIND_CODE = "404";
	public static final String NOT_FIND_MSG = "资源未找到";
	public static final String ERROR_CODE = "500";
	public static final String ERROR_MSG = "系统繁忙，请确认信息后重试！";
